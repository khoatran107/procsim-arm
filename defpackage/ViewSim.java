...
class ViewSim extends Frame implements ActionListener, ChangeListener, ItemListener {
    ...
    public void actionPerformed(ActionEvent actionEvent) {
        ...
        if (actionEvent.getSource() == this.butStepInstruction) {
            ...
            // if (this.dCanvas.animThread.anims.isEmpty()) {
            //     this.dCanvas.animThread.nextAnim();
            // }
        }
    ...
    public PComponent peekNextComp() {
        int nextCompIndex = findNextComp(0);
        if (nextCompIndex != -1) {
            return this.sim.comps.get(nextCompIndex);
        }
        return null;
    }
}